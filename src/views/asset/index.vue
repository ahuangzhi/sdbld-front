  ...
  <el-container id="assets_manage"
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="1.5">
                <el-button type="primary"
                           @click="search_assets"
                           icon="el-icon-search"
                           round>资产搜索</el-button>
              </el-col>
              <el-col :span="1.5"
                      v-if="!isCustomer">
                <el-button round
                           @click="add_button(true)"
                           icon="el-icon-plus"
                           class="spacing20">添加资产</el-button>
              </el-col>
            </el-row>
          </div>
        </el-col>
    ...
    <el-main>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <template v-if="!isCustomer">
              <el-button class="round_button"
                         @click="public_asset(scope.row.id.id)"
                         v-if="scope.row.customerId.id === '13814000-1dd2-11b2-8080-808080808080' && (customer_id === '' || customer_id == null)"
                         title="公开资产">
                <svg class="bld_icon"
                     viewBox="0 0 1024 1024"
                     version="1.1"
              ...
              <el-button class="round_button"
                         @click="del_distribution(scope.row.id.id)"
              ...
              <el-button class="round_button"
                         @click="del_assets(scope.row.id)"
                         slot="reference"
                         v-if="customer_id == '' || customer_id == null"
                         title="删除资产">
                <svg class="bld_icon"
                     viewBox="0 0 1024 1024"
                     version="1.1"
      ...
      <el-pagination @size-change="handleSizeChange"
                     ...
                     :total="search_form.total"></el-pagination>
    </el-main>
    ...
    <el-drawer size="70%"
      ...
      <el-form status-icon
               ref="add_assets_data"
               :model="add_assets_data"
               :rules="add_assets_rules"
               label-width="80px"
               class="assets_add_from">
        ...
        <el-form-item label="资产类型"
          ...
          <el-select filterable
                     allow-create
                     v-model="add_assets_data.type"
                     placeholder="请选择资产类型">
            <el-option v-for="item in assets_types"
                       :key="item"
                       :label="item"
                       :value="item">
            </el-option>
        ...
        <el-form-item>
          <el-button type="primary"
                     @click="add_assets">立即创建</el-button>
    ...
    <el-drawer size="70%"
      ...
      <el-form status-icon
               ref="assets_distribution_data"
               :model="assets_distribution_data"
        ...
        <el-form-item label="资产类型"
                      prop="customer_id"
                      v-if="customer_id === '' || customer_id == null">
          <el-select v-model="assets_distribution_data.customer_id"
                     placeholder="请选择分配客户"
                     size="medium">
            <el-option :key="item.id.id"
        ...
        <el-form-item label="资产列表"
                      prop="assets_id"
                      v-else>
          <el-select v-model="assets_distribution_data.assets_id"
                     placeholder="请选择添加的资产"
                     size="medium">
            <el-option :key="item.id.id"
        ...
        <el-form-item>
          <el-button type="primary"
                     @click="distribution_assets">分配</el-button>
          <el-button @click="add_assets_drawer = false">取消</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>
