...
<div style="padding: 20px;">
  ...
  <el-table :data="tableData.data" height="650" border style="width: 100%" @selection-change="changeFun">
    ...
    <el-table-column prop="timeSectional" label="时段区间" width="680" align="center">
    </el-table-column>
  ...
  <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="this.tableData.pageNum" :page-sizes="[1,2,3,4,5]" :page-size="this.tableData.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="this.tableData.total">
  </el-pagination>
</div>
</template>
