...
export function device_telemetrys () {
  return request({
    url: '/telemetry/getTelemetry.json',
    method: 'get'
  })
}
...
export function updateChangePower (data) {
  return request({
    url: 'telemetry/hzUpdateChangePower.json?gridCompanyPilePower=' + data.gridCompanyPilePower +
      '&photovoltaicPower=' + data.photovoltaicPower + '&chargingPilePower=' + data.chargingPilePower +
      '&energyPower=' + data.energyPower,
    method: 'post'
  })
}
